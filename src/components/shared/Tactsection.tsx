...
import TactImage1 from "../../assets/tactImage1.png"; // Update with your actual image path
import TactImage2 from "../../assets/tactImage2.png"; // Update with your actual image path
          ...
          <div className="grid grid-cols-1 space-x-15 lg:grid-cols-2 gap-12 items-stretch min-h-[700px]">
            ...
            >
              ...
              <div className="mb-auto">
                <p className="text-sm sm:text-2xl  lg:pt-17 text-black leading-relaxed">
                  Tact is the execution arm of Pylon Collective, delivering
